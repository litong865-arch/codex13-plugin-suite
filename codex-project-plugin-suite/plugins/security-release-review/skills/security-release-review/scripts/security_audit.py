...
for (const route of routes) {{
  try {{
    ...
    const lowUser = TOKEN ? await request(route, TOKEN) : null;
...
def self_test() -> int:
    with tempfile.TemporaryDirectory() as td:
        ...
        (root / "src/app/chat.tsx").write_text('"use client"; const apiKey="sk-real-ish-key-12345678901234567890"; export const systemPrompt="secret";', encoding="utf-8")
